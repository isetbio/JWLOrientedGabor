...
# you want to run.
matlab -nodisplay -r "addpath(genpath('/scratch/ek99/JWLOrientedGabor')); addpath(genpath('/scratch/ek99/isetbio')); [expName, saveFolder, seed] = prepHPC($SLURM_ARRAY_TASK_ID); runComputationalObserverModel(expName, 'saveFolder', saveFolder, 'seed', seed); exit()"
