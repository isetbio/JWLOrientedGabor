...
switch lower(expName)
    ...
    case 'default'  
        ...
        expParams.sparams.phases      = [pi/2 3*pi/2];            % Do NOT remove difference in phase of CCW and CW Gabor stimuli
...
%      
    ...
    case 'idealobserver'        
        ...
        expParams.sparams.phases      = pi/2;             % Remove difference in phase of CCW and CW Gabor stimuli
    ...
    case 'defaultnophaseshift'        
     ...
     case 'conedensitynonoise'        
        ...
        expParams.sparams.phases      = [pi/2 3*pi/2];             % Remove difference in phase of CCW and CW Gabor stimuli
