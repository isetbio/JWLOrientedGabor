...
# you want to run.
matlab -nodisplay -r "addpath(genpath('/scratch/ek99/JWLOrientedGabor')); addpath(genpath('/scratch/ek99/isetbio')); expName = 'eyemov'; subFolderName_toLoad = 'paddedStim10'; subFolderName_toSave = 'paddedStim10'; ogRGC_Classify_HPC(expName, subFolderName_toLoad, subFolderName_toSave); exit()"
