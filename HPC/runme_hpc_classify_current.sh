...
#SBATCH --time 30:00:00 # time (D-HH:MM)
...
# you want to run.
matlab -nodisplay -r "addpath(genpath('/scratch/ek99/JWLOrientedGabor')); addpath(genpath('/scratch/ek99/isetbio')); s_ogConeAbsorptions_Classify(); exit()"
