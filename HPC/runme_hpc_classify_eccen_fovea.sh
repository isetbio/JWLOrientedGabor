...
#SBATCH --mem=189GB # memory pool for all cores
...
# you want to run.
matlab -nodisplay -r "addpath(genpath('/scratch/ek99/JWLOrientedGabor')); addpath(genpath('/scratch/ek99/isetbio')); s_ogRGC_Classify_HPC_eccbasedcoverage_fovea; exit()"
