...
# you want to run.
matlab -nodisplay -r "addpath(genpath('/scratch/ek99/JWLOrientedGabor')); addpath(genpath('/scratch/ek99/pf_RV1')); addpath(genpath('/scratch/ek99/isetbio')); runComputationalObserverModel('conedensitynophaseshiftlonly500', 'saveFolder', 'run2', 'seed', 1, 'currentFlag', true, 'hpcArrayID', $SLURM_ARRAY_TASK_ID); exit()"
