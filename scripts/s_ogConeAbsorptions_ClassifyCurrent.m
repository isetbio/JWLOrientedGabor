function s_ogConeAbsorptions_Classify(c)
%
...
for runNr = 1
    ...
    % Folder to save data
    %     serverPth = '/Volumes/server-1/Projects/PerformanceFieldsIsetBio';
    %      serverPth2 = '/Volumes/server-1/Projects/PerformanceFields_RetinaV1Model';
    serverPth = '/scratch/ek99/JWLOrientedGabor/';
    savePth = fullfile(serverPth2, 'data', expName, 'classification', 'current', subFolderName_toSave);
    ...
    for eccen = 1:nrEccen
        ...
        pth = fullfile(serverPth, 'data', expName, subFolderName_toLoad, fname);
