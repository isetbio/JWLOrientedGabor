...
set(gca, 'XScale','log', 'YLim', [40 100], 'TickDir','out','TickLength',[.015 .015],'FontSize',12, 'LineWidth',2);

ylabel('Classifier Accuracy', 'FontSize',12)
if strcmp(whatPlot,'Density'); xlabel('Eccentricity (deg)', 'FontSize',12); else xlabel('Contrast (Michelson)', 'FontSize',12); end
