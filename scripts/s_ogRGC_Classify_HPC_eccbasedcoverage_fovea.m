%% s_ogRGC_Classify_HPC_eccbasedcoverage_fovea
...
for c = expParams.contrastLevels
    ...
    fname = sprintf(...
        ...
        c,expParams.polarAngle,sprintf('%i',expParams.eyemovement(:,1)), expParams.eccentricities(1), expParams.defocusLevels(1), expParams.spatFreq(1));
